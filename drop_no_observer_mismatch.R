...
check_df <- read_csv("~/Library/CloudStorage/Dropbox/Birding/ebird_R/outputs/chk_files/check_ebird_checklist_feb_2025.csv")
...
write_csv(check_clean, "~/Library/CloudStorage/Dropbox/Birding/ebird_R/outputs/chk_files/drop_obs_mismatch/check_ebird_checklist_feb_2025.csv")
